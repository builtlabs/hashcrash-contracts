...
describe("ValueReceiver", function () {
    async function fixture() {
        ...
        const ValueReceiverHarness = await ethers.getContractFactory("ValueReceiverHarness");
        const sut = await ValueReceiverHarness.deploy(await weth.getAddress());
